...
describe('Login', () => {
  ...
  it('deve chamar authService.login com email e senha corretos', () => {
  ...
  it('deve navegar para /feedcolega quando tipo é COLEGA', () => {
    authServiceSpy.login.mockReturnValue(of({ token: 'abc', id: 1, tipo: 'COLEGA' }));
    component.loginForm.patchValue({ email: 'lucas@email.com', senha: 'senha12345' });
    component.onSubmit();
  ...
  it('deve navegar para /feedanfitriao quando tipo é ANFITRIAO', () => {
